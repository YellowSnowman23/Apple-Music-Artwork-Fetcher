...
def _candidate_score_report(score: CandidateScore) -> dict[str, object]:
    return {
        ...
        "release_year": score.candidate.release_year,
        "track_count": score.candidate.track_count,
        "returned_song_count": len(score.candidate.tracks),
        "artwork_url": score.candidate.artwork_url,
